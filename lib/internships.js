  ...
  const internshipsData = [
    {
      ...
      company: 'ZS Associates (https://www.zs.com/)',
      role: 'AI and Backend Engineer',
      description: `
        • Designed and deployed an authoring pipeline for regulatory documents at Amgen and Astrazeneca (Alexion) , automating key steps in the submission process.
        • Developed workflows utilizing LLMs to draft, structure, and validate documents, enabling Amgen scientists to complete 50% of drafts with up to 80% accuracy.
        • Implemented, maintained, and enhanced an end-to-end ingestion pipeline to support downstream processes like document authoring.
        • Created modular agents in LangGraph for tasks such as transforming structured data into narratives, harmonizing terminology, and generating templated sections with contextual precision.
        `,
    },
    {
      id: '4',
      ...
      company: 'DevRev (https://devrev.ai/)',
      role: 'Backend and AI Engineer',
      description: `
        • Contributing to their observability product, recording user sessions for clients like Bajaj, HDFC, and IndusInd Bank
        • Tasked with developing dashboards for clients like Bajaj and HDFC for them to view sessions data and query them in natural language to understand insights about the sessions
        • Developed a chatbot for the sessions data
        • Developing MongoDB aggregations to analyze user screen usage
        • Tasked with enhancing session handling and user properties in Java Spring Boot, and implemented logging to DataDog
        • Completed Golang training, migrated Go code, and updated the Angular Admin Portal with new API parameters
        `,
    },
    {
      id: '2',
